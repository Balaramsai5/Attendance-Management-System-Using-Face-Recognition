    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/balar/PycharmProjects/Face-Recognition-Attendance-System-main/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:\Users\balar\PycharmProjects\Face-Recognition-Attendance-System-main\Attendance\Manually Attendance\-------Check atttendance-------"')
